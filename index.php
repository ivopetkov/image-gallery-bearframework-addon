...
$app->clientShortcuts
        ...
        ->add('-ivopetkov-image-gallery-responsive-attributes', function(IvoPetkov\BearFrameworkAddons\ClientShortcut $shortcut) {
        ...
        ->add('-ivopetkov-image-gallery-lightbox-requirements', function(IvoPetkov\BearFrameworkAddons\ClientShortcut $shortcut) use ($context) {
            ...
            $shortcut->requirements[] = [
                'type' => 'file',
                'url' => $context->assets->getURL('assets/swiper.min.css', ['cacheMaxAge' => 999999999, 'version' => 1]),
                'mimeType' => 'text/css'
            ];
            $shortcut->requirements[] = [
                'type' => 'file',
